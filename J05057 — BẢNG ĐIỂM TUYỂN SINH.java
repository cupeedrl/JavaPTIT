...
class Student {
    ...
    public Student(String id, String name, double math, double physics, double chemistry) {
        ...
        this.total = physics + math * 2 + chemistry;
        this.status = calStatus(total,priority);
    }
    ...
    public String calStatus (double total, double priority){
        if(total + priority >= 24) return "TRUNG TUYEN";
        else return "TRUOT";
    }
    @Override
